    ...
    <table className="detailtable" style={{ width: "100%" }}>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>Year: </span> {props?.HireDate}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Evaluation Forms: </span>{" "}
            {props?.EmployeeID}
          </td>
        </tr>
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>GPA: </span> {props?.EmployeeID}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Forms Filled:</span>
            {props?.EmployeeID}
        ...
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>CGPA: </span> {props?.EmployeeID}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Forms Remaining:</span>
            {props?.EmployeeID}
